...
function checkout($data){
    ...
    $status = "proses";
    $queryOrder = "INSERT INTO order_tiket VALUES ('$idOrder','$tanggal_transaksi', '$struk', '$status')";
    ...
    foreach($_SESSION["cart"] as $id_tiket => $kuantitas) : ?>
        ...
        if($queryOrderDetail){
            $updateKapasitas = mysqli_query($conn, "UPDATE jadwal_penerbangan SET kapasitas_kursi = '$sisaKapasitas'
